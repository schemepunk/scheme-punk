...
module.exports = class destinationSuperBase {
   ...
   */
  init(options, transformedValue, scheme, holdOvers, callPath = '', templateObject = false) {
  ...
  writeDestinationTarget() {
    ...
    return Promise.all([
      ...
      .then(([destinationItem, target, value]) => _.set(this.scheme[destinationItem], target, value)); // eslint-disable-line max-len
  }
