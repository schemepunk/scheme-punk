...
const schemePunkPlugins = {
  destinationPlugins: {
    destroyDestination:
      defaultPluginRequireDirectory
        .destination
        .destroyDestination(superConfig.destination),
    pushDestination:
      defaultPluginRequireDirectory
        .destination
        .pushDestination(superConfig.destination),
    mergeIntoDestination:
      defaultPluginRequireDirectory
        .destination
        .mergeIntoDestination(superConfig.destination),
    concatIntoDestination:
      defaultPluginRequireDirectory
        .destination
        .concatIntoDestination(superConfig.destination)
  },
  sourcePlugins: {
    originalSchemeSource:
      defaultPluginRequireDirectory
        .source
        .originalSchemeSource(superConfig.source),
    activeSchemeSource:
        defaultPluginRequireDirectory
          .source
          .activeSchemeSource(superConfig.source),
    jsonTemplateFileSource:
      defaultPluginRequireDirectory
        .source
        .jsonTemplateFileSource(superConfig.source)
  },
  transformPlugins: {
    appendValuesAdapter:
      defaultPluginRequireDirectory
        .transform
        .typeAdapter(defaultPluginRequireDirectory
          .transform
          .appendValues(superConfig.transform)),
    delimitValues:
      defaultPluginRequireDirectory
        .transform
        .delimitValues(superConfig.transform),
    filterAttribute:
      defaultPluginRequireDirectory
        .transform
        .filterAttributes(superConfig.transform),
    filterAttributeMulti:
      defaultPluginRequireDirectory
        .transform
        .typeAdapter(defaultPluginRequireDirectory
          .transform.filterAttributes(superConfig.transform)),
    objectKeysTransform:
      defaultPluginRequireDirectory
        .transform
        .objectKeysTransform(superConfig.transform),
    prependValuesAdapter:
      defaultPluginRequireDirectory
        .transform
        .typeAdapter(defaultPluginRequireDirectory
          .transform
          .prependValues(superConfig.transform)),
    regexWordBoundariesValues:
      defaultPluginRequireDirectory
        .transform
        .regexWordBoundariesValues(superConfig.transform),
    tokenTemplateValues:
      defaultPluginRequireDirectory
        .transform
        .tokenTemplateValues(superConfig.transform),
