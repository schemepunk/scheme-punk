...
module.exports = (superclass) => class extends superclass {
  /**
     * Function to transform a value by prepending a string to a key,
     *   array member or string. This.options will need a prependValue
     *     in order to work with this transform.
     *
     * @param value
  ...
  async transform(value) {
    ...
    return super.transform(`${value}${appendValue}`);
  }
};
