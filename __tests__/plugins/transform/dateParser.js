...
describe('Date parse', async () => {
  ...
  test('string can be parsed', async () => {
    // Test case value.
    value = '2013-02-08';
    expect(await dateParse.transform(value)).toBe('2013-02-08T00:00:00-06:00');
  });
  ...
  test('string with inputFormat can be parsed', async () => {
    ...
    // Test case value.
    value = '2013-02-08';
    expect(await dateParse.transform(value)).toEqual('2013-02-08T00:00:00-06:00');
  });
  ...
  test('undefined provided gives now.', async () => {
    expect(await dateParse.transform()).toEqual('2013-02-08T00:00:00-06:00');
  });
  ...
  test('problems.', async () => {
    ...
    value = '2013-08-02';
    expect(await dateParse.transform()).toEqual('2013-02-08T06:00:00Z');
  });
});
